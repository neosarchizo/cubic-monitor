...
export default class Packet {
  ...
  getInt16Value: (pos?: number) => number = (pos = 0) => this.buffer.readInt16BE(pos + 3)

  getUInt8Value: (pos?: number) => number = (pos = 0) => this.buffer.readUInt8(pos + 3)

  getUInt16Value: (pos?: number) => number = (pos = 0) => this.buffer.readUInt16BE(pos + 3)

  getUInt32Value: (pos?: number) => number = (pos = 0) => this.buffer.readUInt32BE(pos + 3)
}
